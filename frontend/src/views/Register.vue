      ...
      <div class="auth-card">
        ...
        <form @submit.prevent="handleRegister" class="auth-form">
          <div class="form-group">
            ...
            <input v-model="username" type="text" class="input-field" placeholder="请输入用户名" required minlength="3" />
          </div>

          <div class="form-group">
            <label class="form-label">密码</label>
            <input v-model="password" type="password" class="input-field" placeholder="请输入密码" required minlength="6" />
          </div>
